...
def force_loss_func(output_dict, label_dict=None, weight_dict={}, input_dict=None):
    v = output_dict["v"]
    return -paddle.mean((v * weight_dict["v"]), keepdim=True)
...
if __name__ == "__main__":
    ...
    OUTPUT_DIR = (
        "./output_ntopo_pinn_2d/" if args.output_dir is None else args.output_dir
    )
    ...
    #     input_keys, ("sigma_xx", "sigma_yy", "sigma_xy"), 6, 60
    # )
    ...
    bc_right_corner_disp = ppsci.constraint.BoundaryConstraint(
        ...
        ppsci.loss.FunctionalLoss(force_loss_func),
