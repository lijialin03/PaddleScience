...
class Conv2DBlock(nn.Layer):
    def __init__(self, in_channel, out_channel, kernel_size, stride, use_bn, act):
        super().__init__()
...
class VariantResBlock(nn.Layer):
    def __init__(self, in_channel, out_channels, kernel_sizes, strides, use_bns, acts):
        super().__init__()
...
class Discriminator(base.Arch):
    ...
    def init_layers(self):
        ...
        layers_list.append(
            FullyConnected(self.fc_channel, self.acts[4], mean=0.0, std=0.04, value=0.1)
        )
